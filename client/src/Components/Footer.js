...
function Footer() {
    ...
    return (
        <div className='footer'>
            ...
            <p className='legal1'>NOT AN OFFICIAL SCHITT'S CREEK WEBSITE, IT WAS CREATED TO PROVIDE A FUN TRIVIA GAME TO HELP REMINISCE ABOUT THE MAGIC THAT IS SCHITT'S CREEK.</p>
        </div>    
    )
}
